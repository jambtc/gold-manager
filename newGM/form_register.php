			  ...
			  <table style="color:#000000;" border="0" align="center" cellpadding="0" cellspacing="5" >
				...
				<tr >
					...
					<td width='150' rowspan='5'>
						...
						<input name="scudo_top" type="hidden" id="scudo_top" value="0"/>
						<input name="scudo_middle" type="hidden" id="scudo_middle" value="0"/>
						<input name="scudo_bottom_left" type="hidden" id="scudo_bottom_left" value="0"/>
						<input name="scudo_bottom_center" type="hidden" id="scudo_bottom_center" value="0"/>
						<input name="scudo_bottom_right" type="hidden" id="scudo_bottom_right" value="0"/>
					</td> 
				</tr>
				<tr >
