...
<body onLoad="javascript:cronometro(61);">
	...
	<fieldset>
		...
		// break � il numero dopo cui si deve fermare il conteggio delle prossime partite da giocare
		$break = $conta / (($squadre_serie-1)*2); 
		// visto che ho ordinato per data l'array [0] contiene la prima data utile pertanto � quella con cui si deve giocare la prossima partita!!!
