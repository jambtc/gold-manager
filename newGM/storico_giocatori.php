...
<?php 
	...
	font-family:Geneva, Arial, Helvetica, sans-serif;'>";
			...
			$chart3->setTitle("Abilit� Personali");
			...
			echo "<td align='center'><input id='gio1' name='gio1' value='1' type='radio' onclick='javascript:CambiaGraficoPlayer(1);' checked></td>";
			echo "<td align='center'><input id='gio1' name='gio1' value='2' type='radio' onclick='javascript:CambiaGraficoPlayer(2);'></td>";
			echo "<td align='center'><input id='gio1' name='gio1' value='3' type='radio' onclick='javascript:CambiaGraficoPlayer(3);'></td>";
			echo "<td align='center'><input id='gio1' name='gio1' value='4' type='radio' onclick='javascript:CambiaGraficoPlayer(4);'></td>";
			echo "<td align='center'><input id='gio1' name='gio1' value='5' type='radio' onclick='javascript:CambiaGraficoPlayer(5);'></td>";
			echo "</tr>";
						
			echo "<tr>";
			echo "<td>Preparazione Atletica</td>";
			echo "<td>Abilit�&nbsp;Personali</td>";
