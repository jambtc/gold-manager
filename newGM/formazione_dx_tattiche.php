...
echo "<div id='percentuale_allenamento'>";
	echo "<fieldset style='width: 97%;'>";
		echo "<legend class='legenda'>Percentuale di allenamento</legend>";
		echo "<table id='table_tattiche' cellpadding='5' cellspacing='5' border=0 style='width: 80%;'>";
		for ($ind=0; $ind < 6; $ind++)
		{
			$num = 1 + $ind;
...
echo "<div id='compiti_suggeriti'>";
	echo "<fieldset style='width: 97%;'>";
	echo "<legend class='legenda'>Compiti Suggeriti</legend>";
		echo "<table cellpadding='5' cellspacing='5' border=0 style='width: 80%;'>";
			echo "<tr>";
				echo "<td><img src='images/t_calcidipunizione.png' width=19px height=19px /></td>";
				echo "<td>&nbsp;</td>";
				echo "<td>Punizioni</td>";
				echo "<td>&nbsp;</td>";
				echo "<td class='compiti'><div id='NONmettiqui_70' class='cl_70'><input name='btn' class=\"$class[70]\" value='$ws_specialita[0]' type='button' id='bt_70' title='$title[70]'></div></td>";
				...
				echo "<td>Angoli</td>";
				echo "<td>&nbsp;</td>";
				echo "<td class='compiti'><div id='NONmettiqui_71' class='cl_71'><input name='btn' class=\"$class[71]\" value='$ws_specialita[1]' type='button' id='bt_71' title='$title[71]'></div></td>";
			echo "</tr>";
			...
			echo "<tr>";
				...
				echo "<td>Rigori</td>";
				echo "<td>&nbsp;</td>";
				echo "<td class='compiti'><div id='NONmettiqui_72' class='cl_72'><input name='btn' class=\"$class[72]\" value='$ws_specialita[2]' type='button' id='bt_72' title='$title[72]'></div></td>";
				...
				echo "<td>Capitano</td>";
				echo "<td>&nbsp;</td>";
				echo "<td class='compiti'><div id='NONmettiqui_73' class='cl_73'><input name='btn' class=\"$class[73]\" value='$ws_specialita[3]' type='button' id='bt_73' title='$title[73]'></div></td>";
			echo "</tr>";
		echo "</table>";
	echo "</fieldset>";
echo "</div>";
...
echo "<div id='scelta_tattiche'>";
echo "<fieldset style='width: 97%;'>";
	echo "<legend class='legenda'>Scelta tattiche</legend>";
	echo "<hr>";
	...
	echo "
		<tr>
			<td>Tattica</td>
			<td>
			<select name='ws_TipoTattica' id='ws_TipoTattica' onchange='javascript:Agg_tattiche(1);' class='fld_y'>
		...
		<tr>
			<td>Impegno</td>	
			<td>
			<select name='ws_impegno' id='ws_impegno' onchange='javascript:Agg_tattiche(2);' class='fld_y'>
		...
		<tr>
			<td>Marcatura</td>
			<td>
			<select name='ws_TipoMarcatura' id='ws_TipoMarcatura' onchange='javascript:Agg_tattiche(3);' class='fld_y'>
		...
		<tr>
			<td>Fuorigioco</td>
			<td>
			<select name='ws_fuorigioco' id='ws_fuorigioco' onchange='javascript:Agg_tattiche(4);' class='fld_y'>
...
echo "</div>";
?>
<div class='ch_tattica' style="display:none;">Cambio tattiche</div>
