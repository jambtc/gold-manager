...
$this->title = Yii::t('app', 'Goalkeeper Statistics');
...
<div class="stats-keepers">
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div>
            <h1 class="mb-0 fw-black"><?= Yii::t('app', 'Goalkeeper Statistics') ?></h1>
        ...
        <div class="d-flex gap-2 align-items-center">
            ...
            <?= Html::a('<i class="bi bi-table"></i> ' . Yii::t('app', 'Teams'), ['/stats/team', 'season' => $season, 'tier' => $tier], ['class' => 'btn btn-outline-gold btn-sm', 'encode' => false]) ?>
        </div>
    </div>
            ...
            <table class="table-gm w-100 mb-0">
                <thead>
                    <tr>
                        ...
                        <th><?= Yii::t('app', 'Goalkeeper') ?></th>
                        <th><?= Yii::t('app', 'Team') ?></th>
                        <th class="text-center"><?= Yii::t('app', 'Matches') ?></th>
                        <th class="text-center"><?= Yii::t('app', 'Min') ?></th>
                        <th class="text-center"><?= Yii::t('app', 'Sub goals') ?></th>
                        <th class="text-center"><?= Yii::t('app', 'Saves') ?></th>
