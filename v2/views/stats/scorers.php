...
$this->title = 'Classifica Marcatori';
$this->params['breadcrumbs'][] = $this->title;

$baseUrl = Url::to(['/stats/scorers']);
?>

<div class="stats-scorers">
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div>
            <h1 class="mb-0 fw-black">Classifica Marcatori</h1>
        ...
        <div class="d-flex gap-2 align-items-center">
            ...
            <?= Html::a('<i class="bi bi-people"></i> Assist', ['/stats/assists', 'season' => $season, 'tier' => $tier], ['class' => 'btn btn-outline-gold btn-sm', 'encode' => false]) ?>
            <?= Html::a('<i class="bi bi-shield-check"></i> Portieri', ['/stats/keepers', 'season' => $season, 'tier' => $tier], ['class' => 'btn btn-outline-gold btn-sm', 'encode' => false]) ?>
        </div>
    </div>
                    ...
                    <?php else: ?>
                        <?php foreach ($rows as $i => $r): ?>
                            <tr>
                                ...
                                <td class="text-center fw-bold text-gold"><?= (int) $r['goals'] ?></td>
                                <td class="text-center"><?= (int) $r['assists'] ?></td>
