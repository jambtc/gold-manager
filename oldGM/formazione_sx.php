...
<table width="90%" border="0" style="color:#000000;">
<tr>
	<td width='10'>&nbsp;</td>
...
while   ($row = mysql_fetch_array($result))
{
	...
	$col = array("#6699FF","#CC3300","#CC3300","#CC3300","#00CC66","#00CC66","#00CC66","#CC66CC","#CC66CC","#CC66CC");
	...
	echo "<td bgcolor=$col[0] width='16'><span class=$classe[0]><center>$po</span></td>" ;
	echo "<td bgcolor=$col[1] width='16'><span class=$classe[1]><center>$ds</span></td>";
	echo "<td bgcolor=$col[2] width='16'><span class=$classe[2]><center>$dc</span></td>";
	echo "<td bgcolor=$col[3] width='16'><span class=$classe[3]><center>$dd</span></td>";
	echo "<td bgcolor=$col[4] width='16'><span class=$classe[4]><center>$cs</span></td>";
	echo "<td bgcolor=$col[5] width='16'><span class=$classe[5]><center>$cc</span></td>";
	echo "<td bgcolor=$col[6] width='16'><span class=$classe[6]><center>$cd</span></td>";
	echo "<td bgcolor=$col[7] width='16'><span class=$classe[7]><center>$as</span></td>";
	echo "<td bgcolor=$col[8] width='16'><span class=$classe[8]><center>$ac</span></td>";
	echo "<td bgcolor=$col[9] width='16'><span class=$classe[9]><center>$ad</span></td>";
	echo "</tr>";
