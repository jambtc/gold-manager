...
{
	echo "<script>javascript:alert('ERRORE! Numero di maglia ($_REQUEST[err]) gi� assegnato!');</script>";
}
...
echo "			<tr style='font-size: 14px; color:#FFFF00; font-family:Geneva, Arial, Helvetica, sans-serif; '>
					...
					<th style='background-color:#009000;' width='10' align='left'>Et� </td>
...
echo "<span class='top-label'>";
echo "	<span class='label-txt'>Abilit� Personali</span>";
echo "</span> ";
echo "<div class='content-area'>";
