...
<?php 
	...
	if ($a == 1)
	{
		...
		if ($totale != 0) {
			...
			echo "<tr>
					<th height='15' align='right'>Giocatore pi� costoso</th>
					<th align='left'>�. $gcos</th>
					<th align='left'>$gnome</th>
				  </tr>";
	
			echo "<tr>
					<th height='15' align='right'>Giocatore pi� giovane</th>
					<th align='left'>$wetagiov Anni</th>
					<th align='left'>$wgiovane</th>
				  </tr>";
				 
			echo "<tr>
					<th height='15' align='right'>Giocatore pi� vecchio</th>
					<th align='left'>$wetavecc Anni</th>
					<th align='left'>$wvecchio</th>
				  </tr>";

			echo "<tr>
					<th height='15' align='right'>Et� media</th>
	...
	if ($a == 4)
	{
		...
		if ($totgio != 0)
		{
			...
			DisegnaGrafico($xx,$yy,$abilita,"Abilit� - totale","generated/".$nome_team.$random."_grafico_1t.png",1);
			...
			DisegnaGrafico($xx,$yy,$abilita,"Abilit� - media","generated/".$nome_team.$random."_grafico_1m.png",$totgio/100);
			...
			echo "<table border='0' cellpadding='3' cellspacing='3' >
				  <tr>
					<td width='200'  align='left' valign='middle'>
						...
						<tr><th align='left'>
							<input name='atletica' value='1' type='radio' onclick='javascript:check(1);' checked>Abilit�
						</th></tr>
						
						<tr><th align='left'>
							<input name='atletica' value='2' type='radio' onclick='javascript:check(2);'>Forma
						</th></tr>
						<tr><th align='left'>
								<input name='atletica' value='3' type='radio' onclick='javascript:check(3);'>Freschezza
						</th></tr>
						<tr><th align='left'>
								<input name='atletica' value='4' type='radio' onclick='javascript:check(4);'>Condizione
						</th></tr>
						<tr><th align='left'>
								<input name='atletica' value='5' type='radio' onclick='javascript:check(5);'>Esperienza
						</th></tr>
						</table>
					</td>
					<td rowspan='2'>
						<iframe  src=\"grafico.php?atl=$atletica\" height='400' width='400' allowtransparency='1' name='grafico' frameborder='0'></iframe>
					</td>
				</tr>
	...
	if ($a == 5)
	{
		...
		if ($totgio != 0) {
			...
			echo "<input id='abilita' name='abilita' value='6'  type='radio' onclick='javascript:check(6);' checked>Parate";
			echo "</th></tr>";
			
			echo "<tr><th align='left'>";
			echo "<input id='abilita' name='abilita' value='7'  type='radio' onclick='javascript:check(7);'>Difesa";
			echo "</th></tr>";
			echo "<tr><th align='left'>";
			echo "<input id='abilita' name='abilita' value='8'  type='radio' onclick='javascript:check(8);'>Contrasti";
			echo "</th></tr>";
			echo "<tr><th align='left'>";
			echo "<input id='abilita' name='abilita' value='9'  type='radio' onclick='javascript:check(9);'>Passaggi";
			echo "</th></tr>";
			echo "<tr><th align='left'>";
			echo "<input id='abilita' name='abilita' value='10'  type='radio' onclick='javascript:check(10);'>Regia";
			echo "</th></tr>";
			echo "<tr><th align='left'>";
			echo "<input id='abilita' name='abilita' value='11'  type='radio' onclick='javascript:check(11);'>Cross";
			echo "</th></tr>";
			echo "<tr><th align='left'>";
			echo "<input id='abilita' name='abilita' value='12'  type='radio' onclick='javascript:check(12);'>Tecnica";
			echo "</th></tr>";
			echo "<tr><th align='left'>";
			echo "<input id='abilita' name='abilita' value='13'  type='radio' onclick='javascript:check(13);'>Tiro";
			echo "</th>
					<input id='ws_random' name='ws_random' value='$random' type='hidden'/>
			</tr>";
			...
			echo "<table border='0' cellpadding='0' cellspacing='0' >
				  <tr>
					<td width='200'  align='left' valign='middle'>
						<table border='0' cellpadding='0' cellspacing='0' >
						<tr ><th align='left'>
						<input id='risultati' name='risultati' value='14'  type='radio' onclick='javascript:check(14);' checked>Partite
							</th></tr>
						<tr><th align='left'>
							<input id='risultati' name='risultati' value='15'  type='radio' onclick='javascript:check(15);'>Goal
						</th></tr>
						<tr><th align='left'>
							<input id='risultati' name='risultati' value='16'  type='radio' onclick='javascript:check(16);'>Ammonizioni
						</th></tr>
						<tr><th align='left'>
						<input id='risultati' name='risultati' value='17'  type='radio' onclick='javascript:check(17);'>Espulsioni
						</th></tr>
						<input id='ws_random' name='ws_random' value='$random' type='hidden'/>
			...
			echo "<table border='0' cellpadding='0' cellspacing='0' >
				  <tr>
					<td width='200'  align='left' valign='middle'>
						<table border='0' cellpadding='0' cellspacing='0' >
						<tr><th align='left'>
							<input id='bilancio' name='bilancio' value='1'  type='radio' onclick='javascript:check(18);' checked>Stipendio
							</th></tr>
						<tr><th align='left'>
						<input id='bilancio' name='bilancio' value='2'  type='radio' onclick='javascript:check(19);'>Valore
						</th></tr>
						<input id='ws_random' name='ws_random' value='$random' type='hidden'/>
						</table>
					</td>
	...
	if ($a == 9){
		...
		if ($totale != 0) {
			...
			echo "<tr>";
			echo "<td height='30' width='100' ><center><h4>Q7</h4></td>";
			echo "<td height='30' width='100' ><center><h4>Q8</h4></td>";
			echo "<td height='30' width='100' ><center><h4>Q9</h4></td>";
			echo "</tr>";
			echo "<tr>";
			echo "<td height='30' width='100' ><center>$xats</td>"; //attacco sinistro
			echo "<td height='30' width='100' ><center>$xatc</td>"; //attacco centrale
			echo "<td height='30' width='100' ><center>$xatd</td>"; //attacco destro
			echo "</tr>";			
			
			echo "<tr>";
			echo "<td height='30' width='100' ><center><h4>Q4</h4></td>";
			echo "<td height='30' width='100' ><center><h4>Q5</h4></td>";
			echo "<td height='30' width='100' ><center><h4>Q6</h4></td>";
			echo "</tr>";
			echo "<tr>";
			echo "<td height='30' width='100' ><center>$xces</td>"; //centrocampista sinistro
			echo "<td height='30' width='100' ><center>$xcec</td>"; //centrocampista centrale
			echo "<td height='30' width='100' ><center>$xced</td>"; //centrocampista destro
			echo "</tr>";		
			
			echo "<tr>";
			echo "<td height='30' width='100' ><center><h4>Q1</h4></td>";
			echo "<td height='30' width='100' ><center><h4>Q2</h4></td>";
			echo "<td height='30' width='100' ><center><h4>Q3</h4></td>";
			echo "</tr>";
			echo "<tr>";
			echo "<td height='30' width='100' ><center>$xdfs</td>"; //difensore sinistro
			echo "<td height='30' width='100' ><center>$xdfc</td>"; //difensore centrale
			echo "<td height='30' width='100' ><center>$xdfd</td>"; //difensore destro
			echo "</tr>";			
			
			echo "<tr>";
			echo "<td height='30' width='100' ></td>";
			echo "<td height='30' width='100' ><center><h4>Q0</h4></td>";
			echo "<td height='30' width='100' ></td>";
			echo "</tr>";
			echo "<tr>";
			echo "<td>&nbsp;</td>";
			echo "<td height='30' width='100' ><center>$xpor</td>"; //portiere
			echo "<td>&nbsp;</td>";
			echo "</tr>";			
	...
	if ($a == 41) // statistiche staff
	{
		...
		if ($totale != 0)
		{
			...
			//echo "    <th width='180' align='left'>Caratt.</th>";
			//echo "    <th width='180' align='left'>Filos.</th>";
			...
			{
				echo "<tr>";
				echo "<td><a class='a1' href='staff_storico.php?scelta=$id[$conta]' target='grafico_staff' >$elenco</a></td>";
	...
	if ($a == 40) // statistiche giocatori
	{
		...
		if ($totale != 0)
		{
			...
			foreach ($nome as $elenco)
			{
				...
				echo "<td><a class='a1' href='#' onClick =\"winpiccola('giocatori_storico.php?scelta=$id[$conta]','$elenco','width=610,height=350')\">$elenco</a></td>";
