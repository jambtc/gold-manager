...
echo "<div id='campo_formazione'>
		<img src='images/in_campo.png' id='campo_formazione' border='0'>
	</div>";
echo "<div id='panchina_formazione' >
		<img src='images/panchina_di_gioco.png' id='panchina_formazione' >
	</div>";

// FORMAZIONE
echo "<form name='field' border='0'>";
//echo "<input id='frmzn' type='hidden' value='$QualeFormazione'>";
...
for ($x=1; $x<10; $x++)
{
	...
	for ($y=1+(($x-1)*7); $y<8+(($x-1)*7); $y++) // 7 � il numero di giocatori per riga
	{
		echo "<td>
...
for ($y=65; $y<70; $y++)
{
	...
	echo "<div id='speciale_formazione'>";
		...
		echo "<legend>Compiti Speciali</legend>";
...
echo "<div id='forza_formazione'>
		<table border='0' cellpadding='0' cellspacing='1'>
			<tr><td>Forza</td><td>:&nbsp;$Forza</td></tr>
			<tr><td>Forma</td><td>:&nbsp;$Forma&nbsp;%</td></tr>
			<tr><td>Freschezza</td><td>:&nbsp;$Freschezza&nbsp;%</td></tr>
			<tr><td>Condizione</td><td>:&nbsp;$Condizione&nbsp;%</td></tr>
			<tr><td>Caratteri</td>";
			if ($ContaCar >= 5)
			{
...
echo "<div id='scegli_formazione'>";
echo "<table border='1' cellpadding='5' cellspacing='5'>";
echo "<tr>
		<td>
			<div class='ch_formaz'><input id='ws_pagina' name='ws_pagina' type='hidden' value='$tabella' /></div>
		<select name='ws_formazione' id='ws_formazione' onchange='javascript:Formazione();' class='fld_y'>
			<option value='$QualeFormazione' selected='selected'>$QualeFormazione</option>
			<option value='$QualeFormazione'>---------------</option>
