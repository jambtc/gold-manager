			...
			<div id='sede_notizie' >
				<?php
					...
					{	
						...
						$msg = "Benvenuto $nome_utente. Ora sei il nuovo manager della squadra $nome_team.<br>Ricordati che la Dirigenza ha puntato tutto su di te per portare la squadra nella massima serie.<br>Ti � stato affidato un budget di �. 250.000 da far fruttare e 18 giocatori che dovrai allenare al meglio delle tue possibilit�.<br>Ora � tutto nelle tue mani. In bocca al lupo.";
