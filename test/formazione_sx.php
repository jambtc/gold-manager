...
<tr style="background-color:#006600; border:#666666 solid 2px; font-size:14px; font-weight:bold; color:#FFFFFF;">
	<td width='10'>&nbsp;</td>
...
while   ($row = mysql_fetch_array($result))
{
	...
	if ($row['pos'] == "PO")
	{
		echo "<td><div class='my_players'><img id='$row[id]' name='$row[nr]' src='images/maglietta_arancione.png' width='24' height='29' onmouseout='javascript:tooltip_hide();' /><input class='brdlist_player' value=$row[nr] type='button'></div></td>";
	}
	else
	{
		echo "<td><div class='my_players'><img id='$row[id]' name='$row[nr]' src='images/maglietta_azzurra.png' width='24' height='29' onmouseout='javascript:tooltip_hide();' /><input class='brdlist_player' value=$row[nr] type='button'></div></td>";
	}
	*/
